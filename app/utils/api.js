export const API_BASE_URL =
  "https://vote-count-management-system-backend.onrender.com/api";

export const API_CANDIDATES_URL = `${API_BASE_URL}/candidates/`;
export const API_CANDIDATE_IMAGE_URL = `${API_BASE_URL}/candidates/image/`;
...
export const API_ROUNDS_SAVE_URL = `${API_BASE_URL}/rounds/save`;
